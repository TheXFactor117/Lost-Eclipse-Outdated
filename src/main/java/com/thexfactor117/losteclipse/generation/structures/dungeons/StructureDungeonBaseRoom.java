 ...
 * 
 * Offers as a base building block for all other dungeon modules. Copy, paste, and edit for new rooms.
 */
public class StructureDungeonBaseRoom extends StructureLEBase
{
	protected EnumFacing facing;
	
	public StructureDungeonBaseRoom(EnumFacing facing)
	{
		this.facing = facing;
	}
