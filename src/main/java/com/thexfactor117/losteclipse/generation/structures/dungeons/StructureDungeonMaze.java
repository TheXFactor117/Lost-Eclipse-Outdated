 ...
 *
 */
public class StructureDungeonMaze extends StructureLEBase
{
	protected EnumFacing facing;
	
	public StructureDungeonMaze(EnumFacing facing)
	{
		this.facing = facing;
	}
	...
	private final int[][] stoneBricksPos = new int[][]
	{
		...
		{5, 3, 0}, {5, 3, 1}, {5, 3, 2}, {5, 3, 3}, {5, 3, 4}, {5, 3, 5}, {5, 3, 6}, {5, 3, 7}, {5, 3, 8}, {5, 3, 9}, {5, 3, 10},
		{6, 3, 0}, {6, 3, 1}, {6, 3, 2}, {6, 3, 3}, {6, 3, 4}, {6, 3, 5}, {6, 3, 6}, {6, 3, 7}, {6, 3, 8}, {6, 3, 9}, {6, 3, 10},
		{7, 3, 0}, {7, 3, 1}, {7, 3, 2}, {7, 3, 3}, {7, 3, 4}, {7, 3, 5}, {7, 3, 6}, {7, 3, 7}, {7, 3, 8}, {7, 3, 9}, {7, 3, 10},
		{8, 3, 0}, {8, 3, 1}, {8, 3, 2}, {8, 3, 3}, {8, 3, 4}, {8, 3, 5}, {8, 3, 6}, {8, 3, 7}, {8, 3, 8}, {8, 3, 9}, {8, 3, 10},
		{9, 3, 0}, {9, 3, 1}, {9, 3, 2}, {9, 3, 3}, {9, 3, 4}, {9, 3, 5}, {9, 3, 6}, {9, 3, 7}, {9, 3, 8}, {9, 3, 9}, {9, 3, 10},
		...
		// maze 1
		{9, 1, 3}, {9, 1, 4}, {9, 1, 6},
		{8, 1, 3}, {8, 1, 2}, {8, 1, 4}, {8, 1, 6}, {8, 1, 8},
		{7, 1, 6}, {7, 1, 8}, 
		{6, 1, 1}, {6, 1, 3}, {6, 1, 4}, {6, 1, 5}, {6, 1, 6}, {6, 1, 8},
		{5, 1, 3}, {5, 1, 8}, 
		{4, 1, 1}, {4, 1, 5}, {4, 1, 7}, {4, 1, 8}, {4, 1, 9},
		{3, 1, 3}, {3, 1, 4}, {3, 1, 5}, {3, 1, 8},
		{2, 1, 2}, {2, 1, 3}, {2, 1, 4}, {2, 1, 5}, {2, 1, 6}, {2, 1, 8},
		{1, 1, 6},
		// maze 2
		{9, 2, 3}, {9, 2, 4}, {9, 2, 6},
		{8, 2, 3}, {8, 2, 2}, {8, 2, 4}, {8, 2, 6}, {8, 2, 8},
		{7, 2, 6}, {7, 2, 8}, 
		{6, 2, 1}, {6, 2, 3}, {6, 2, 4}, {6, 2, 5}, {6, 2, 6}, {6, 2, 8},
		{5, 2, 3}, {5, 2, 8},
		{4, 2, 1}, {4, 2, 5}, {4, 2, 7}, {4, 2, 8}, {4, 2, 9},
		{3, 2, 3}, {3, 2, 4}, {3, 2, 5}, {3, 2, 8},
		{2, 2, 2}, {2, 2, 3}, {2, 2, 4}, {2, 2, 5}, {2, 2, 6}, {2, 2, 8},
		{1, 2, 6},
	};
