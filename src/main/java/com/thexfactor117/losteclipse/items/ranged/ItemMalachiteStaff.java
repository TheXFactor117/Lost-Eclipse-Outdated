...
{
	public ItemMalachiteStaff(String name, Rarity rarity, int soulsPerUse) 
	{
		...
		this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter()
		{
            ...
            public float apply(ItemStack stack, @Nullable World world, @Nullable EntityLivingBase entity)
            {
                ...
                else
                {
                    ...
                    return itemstack != null && itemstack.getItem() == ModArmory.malachiteStaff ? (float)(stack.getMaxItemUseDuration() - entity.getItemInUseCount()) / 20.0F : 0.0F;
                }
            }
		});
